...
1. [PENDING] Splash screen not showing
2. [PENDING] Logo on Splash Screen should be exactly centered (width and height)
3. [PENDING] The yellow arrow in the logo (splash + home) should be closer to the text, not far away
4. [PENDING] The yellow arrow is not stable on Splash Screen — it enters from left to right
5. [PENDING] Logo on home screen hasn't changed (should update to new logo)

---

## App Icon

6. [PENDING] Change the app icon design
...
8. [PENDING] First app launch takes too long
...
## Home Screen - Sponsored Trips

11. [BLOCKED] Sponsored trips section should have a different and smaller design (client unsure of exact look — needs help)
...
17. [DONE] Category page titles in home screen are centered — should be aligned to the left (start)
...
## Trip Details Page - Program / Itinerary

36. [DONE] First day should be auto-expanded on load
37. [DONE] When opening another day, both stay open (multi-expand, not single accordion)
38. [DONE] Closing any day should work by tapping anywhere on it, not just the header

---

## Trip Details Page - Transportation

39. [DONE] Remove the company name for transportation (bus, boat, etc.) — show only the vehicle name

---

## Trip Details Page - Icons / Images

40. [BLOCKED] Change the images for language, vaccinations, and visa (client will send new designs)
...
59. [DONE] The entire banner/ads section should be fully clickable (link)
...
66. [BLOCKED] Customer service screen should match the Figma design

---

## App Bar (Header) - Static Adjustments

67. [DONE] Reduce vertical padding above the logo
68. [DONE] Reduce space between search bar and location row
69. [DONE] Reduce header height by about 20%
70. [DONE] Make the logo slightly bigger
