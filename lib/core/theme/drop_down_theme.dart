...
class DropdownTheme {
  static CustomDropdownDecoration dropdownMultiSelectDecoration({
    required BuildContext context,
    Color? color,
    Color? borderColor,
  }) {
    return CustomDropdownDecoration(
      hintStyle: TextStyles.textViewRegular12.copyWith(
      ...
      closedErrorBorder: Border.all(color: AppColors.error, width: 1.5.r),
      ...
      errorStyle: TextStyles.textViewRegular12.copyWith(
